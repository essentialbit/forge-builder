...
export const sectionRegistry: Record<string, SectionDefinition> = {
  ...
  'category-copy-editor': {
    ...
    defaultSettings: {
      ...
      // Collection pages (cross-category, tag-based)
      moissanite_title: 'GRA Certified Moissanite',
      moissanite_subtitle: 'VVS1 D-Colour stones — same brilliance as diamond, 2.5× the fire. Every piece GRA certified.',
      moissanite_image: '/images/products/FJ-RG-0458.jpg',
      cuban_chains_title: 'Cuban Link Chains',
      cuban_chains_subtitle: 'Miami Cubans, box cubans, micro-cubans — the chain that defines streetwear luxury.',
      cuban_chains_image: '/images/products/FJ-NC-0542.jpg',
      tennis_title: 'Tennis Jewellery',
      tennis_subtitle: 'Tennis bracelets and necklaces with hand-placed CZ stones. Flexible-set for all-day wear.',
      tennis_image: '/images/categories/bracelets.jpg',
      pearl_title: 'Pearl Collection',
      pearl_subtitle: 'Freshwater and baroque pearls — classic reimagined for the modern wardrobe.',
      pearl_image: '/images/categories/necklaces.jpg',
      iced_out_title: 'Iced Out',
      iced_out_subtitle: 'CZ-set pendants, iced chains, rings and bracelets — all hand-finished stone-set.',
      iced_out_image: '/images/categories/rings.jpg',
    },
    schema: {
      ...
      moissanite_title: { type: 'text', label: 'Moissanite Collection — Page Title' },
      moissanite_subtitle: { type: 'textarea', label: 'Moissanite Collection — Subtitle' },
      moissanite_image: { type: 'image', label: 'Moissanite Collection — Hero Image' },
      cuban_chains_title: { type: 'text', label: 'Cuban Chains — Page Title' },
      cuban_chains_subtitle: { type: 'textarea', label: 'Cuban Chains — Subtitle' },
      cuban_chains_image: { type: 'image', label: 'Cuban Chains — Hero Image' },
      tennis_title: { type: 'text', label: 'Tennis Collection — Page Title' },
      tennis_subtitle: { type: 'textarea', label: 'Tennis Collection — Subtitle' },
      tennis_image: { type: 'image', label: 'Tennis Collection — Hero Image' },
      pearl_title: { type: 'text', label: 'Pearl Collection — Page Title' },
      pearl_subtitle: { type: 'textarea', label: 'Pearl Collection — Subtitle' },
      pearl_image: { type: 'image', label: 'Pearl Collection — Hero Image' },
      iced_out_title: { type: 'text', label: 'Iced Out Collection — Page Title' },
      iced_out_subtitle: { type: 'textarea', label: 'Iced Out Collection — Subtitle' },
      iced_out_image: { type: 'image', label: 'Iced Out Collection — Hero Image' },
    },
  },
